...
#    cv2.waitKey(300) 
    ...
    if rdis>WARNING_DISTANCE:
       ...
       cv2.putText(image,"System is normal",(10,20),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,0),2)
...
def get_dis(image_path1,image_path2):
    first_image = cv2.imread(image_path1)
...
if __name__ == "__main__": 
    while(1):
        ...
        print(focalLength)
        rdis = get_dis(img_path,new_photo)
  
        calculate_Distance(new_photo,focalLength,rdis)
#        cv2.waitKey(1000)
        c=c+1
